...
set nocursorcolumn              " Do not show highlight column of where cursor is
set cursorline                  " Show highlighted row of where cursor is
...
" This comes first, because we have map:clpings that depend on leader
